...
const SYSTEM_FIELDS = [
  { group: "ব্যক্তিগত", color: "cyan", source: "Student → Profile → Personal Info", fields: [
    { key: "name_en", label: "নাম (Full English)" }, { key: "name_en:first", label: "নাম → First Name" }, { key: "name_en:last", label: "নাম → Last Name" },
    { key: "name_katakana", label: "নাম (カタカナ)" }, { key: "name_katakana:first", label: "カタカナ → First" }, { key: "name_katakana:last", label: "カタカナ → Last" },
  ...
  { group: "পাসপোর্ট / NID", color: "amber", source: "Student → Profile → Passport & Family", fields: [
    ...
    { key: "passport_issue", label: "পাসপোর্ট ইস্যু" }, { key: "passport_issue:year", label: "ইস্যু → Year" }, { key: "passport_issue:month", label: "ইস্যু → Month" }, { key: "passport_issue:day", label: "ইস্যু → Day" },
    { key: "passport_expiry", label: "পাসপোর্ট মেয়াদ" }, { key: "passport_expiry:year", label: "মেয়াদ → Year" }, { key: "passport_expiry:month", label: "মেয়াদ → Month" }, { key: "passport_expiry:day", label: "মেয়াদ → Day" },
  ]},
  ...
  { group: "পরিবার", color: "purple", source: "Student → Profile → Family Members (Add)", fields: [
    ...
    { key: "father_dob", label: "পিতার জন্ম তারিখ" }, { key: "father_dob:year", label: "পিতার জন্ম → Year" }, { key: "father_dob:month", label: "পিতার জন্ম → Month" }, { key: "father_dob:day", label: "পিতার জন্ম → Day" },
    { key: "father_occupation", label: "পিতার পেশা" }, { key: "father_phone", label: "পিতার ফোন" },
    { key: "mother_dob", label: "মাতার জন্ম তারিখ" }, { key: "mother_dob:year", label: "মাতার জন্ম → Year" }, { key: "mother_dob:month", label: "মাতার জন্ম → Month" }, { key: "mother_dob:day", label: "মাতার জন্ম → Day" },
    { key: "mother_occupation", label: "মাতার পেশা" }, { key: "mother_phone", label: "মাতার ফোন" },
  ]},
  { group: "পরিবার (বিস্তারিত)", color: "purple", source: "Student → Profile → Family Members (Add)", fields: [
    { key: "family1_name", label: "সদস্য ১ নাম" }, { key: "family1_relation", label: "সদস্য ১ সম্পর্ক" }, { key: "family1_dob", label: "সদস্য ১ জন্ম" }, { key: "family1_occupation", label: "সদস্য ১ পেশা" }, { key: "family1_address", label: "সদস্য ১ ঠিকানা" },
  ...
  { group: "শিক্ষা", color: "amber", source: "Student → Profile → Education (Level + School Type)", fields: [
    // ── SSC (= Junior High 中学校 ৬-১০) ──
    { key: "edu_ssc_school", label: "SSC স্কুল (BD format)" }, { key: "edu_ssc_year", label: "SSC সন" }, { key: "edu_ssc_board", label: "SSC বোর্ড" }, { key: "edu_ssc_gpa", label: "SSC GPA" }, { key: "edu_ssc_subject", label: "SSC বিভাগ" },
    { key: "edu_ssc_address", label: "SSC ঠিকানা" }, { key: "edu_ssc_entrance", label: "SSC ভর্তি সন" },
    // ── HSC (= High School 高等学校 ১১-১২) ──
    { key: "edu_hsc_school", label: "HSC কলেজ (BD format)" }, { key: "edu_hsc_year", label: "HSC সন" }, { key: "edu_hsc_board", label: "HSC বোর্ড" }, { key: "edu_hsc_gpa", label: "HSC GPA" }, { key: "edu_hsc_subject", label: "HSC বিভাগ" },
    { key: "edu_hsc_address", label: "HSC ঠিকানা" }, { key: "edu_hsc_entrance", label: "HSC ভর্তি সন" },
    // ── Honours (= University 大学) ──
    { key: "edu_honours_school", label: "Honours বিশ্ববিদ্যালয় (BD format)" }, { key: "edu_honours_year", label: "Honours সন" }, { key: "edu_honours_gpa", label: "Honours GPA" }, { key: "edu_honours_subject", label: "Honours বিষয়" },
    { key: "edu_honours_address", label: "Honours ঠিকানা" }, { key: "edu_honours_entrance", label: "Honours ভর্তি সন" },
    // ── Elementary 小学校 (১-৫ শ্রেণী) ──
    ...
    // ── Junior High 中学校 = SSC (৬-১০ শ্রেণী) ──
    { key: "edu_junior_school", label: "জুনিয়র/SSC (中学校) স্কুল" }, { key: "edu_junior_address", label: "জুনিয়র/SSC ঠিকানা" },
    ...
    { key: "edu_junior_graduation", label: "জুনিয়র/SSC পাশ" }, { key: "edu_junior_graduation:year", label: "জুনিয়র পাশ → Year" }, { key: "edu_junior_graduation:month", label: "জুনিয়র পাশ → Month" },
    { key: "edu_junior_years", label: "জুনিয়র বছর সংখ্যা (auto)" },
    // ── High School 高等学校 = HSC (১১-১২ শ্রেণী) ──
    { key: "edu_highSchool_school", label: "হাই স্কুল/HSC (高等学校) কলেজ" }, { key: "edu_highSchool_address", label: "হাই স্কুল/HSC ঠিকানা" },
    ...
    { key: "edu_highSchool_graduation", label: "হাই স্কুল/HSC পাশ" }, { key: "edu_highSchool_graduation:year", label: "হাই স্কুল পাশ → Year" }, { key: "edu_highSchool_graduation:month", label: "হাই স্কুল পাশ → Month" },
  ...
  { group: "জাপানি ভাষা পরীক্ষা", color: "rose", source: "Student → Profile → JP Exams", fields: [
    ...
    { key: "jp_exam_date", label: "পরীক্ষার তারিখ" }, { key: "jp_exam_date:year", label: "পরীক্ষা → Year" }, { key: "jp_exam_date:month", label: "পরীক্ষা → Month" }, { key: "jp_exam_date:day", label: "পরীক্ষা → Day" },
  ]},
  { group: "জাপানি শিক্ষা ইতিহাস", color: "purple", source: "Auto: Agency নাম + Batch dates | Manual: JP Study Add", fields: [
    { key: "jp_study_institution", label: "প্রতিষ্ঠান" }, { key: "jp_study_address", label: "প্রতিষ্ঠান ঠিকানা" },
    { key: "jp_study_from", label: "শুরু তারিখ" }, { key: "jp_study_from:year", label: "শুরু → Year" }, { key: "jp_study_from:month", label: "শুরু → Month" }, { key: "jp_study_from:day", label: "শুরু → Day" },
    { key: "jp_study_to", label: "শেষ তারিখ" }, { key: "jp_study_to:year", label: "শেষ → Year" }, { key: "jp_study_to:month", label: "শেষ → Month" }, { key: "jp_study_to:day", label: "শেষ → Day" },
    { key: "jp_study_hours", label: "মোট ঘণ্টা" },
  ]},
  { group: "কর্ম অভিজ্ঞতা (職歴)", color: "emerald", source: "Student → Profile → Work Experience", fields: [
    { key: "work_company", label: "কোম্পানি নাম" }, { key: "work_address", label: "কোম্পানি ঠিকানা" }, { key: "work_position", label: "পদবি" },
    { key: "work_start", label: "শুরু তারিখ" }, { key: "work_start:year", label: "শুরু → Year" }, { key: "work_start:month", label: "শুরু → Month" },
    { key: "work_end", label: "শেষ তারিখ" }, { key: "work_end:year", label: "শেষ → Year" }, { key: "work_end:month", label: "শেষ → Month" },
    { key: "work2_company", label: "২য় কোম্পানি" }, { key: "work2_address", label: "২য় ঠিকানা" }, { key: "work2_position", label: "২য় পদবি" },
    { key: "work2_start", label: "২য় শুরু" }, { key: "work2_end", label: "২য় শেষ" },
  ]},
  { group: "পড়াশোনার পরিকল্পনা", color: "cyan", source: "Student → Profile → Purpose of Study", fields: [
    { key: "reason_for_study", label: "পড়ার কারণ" }, { key: "future_plan", label: "ভবিষ্যৎ পরিকল্পনা" }, { key: "study_subject", label: "পড়ার বিষয়" },
  ]},
  { group: "স্পন্সর", color: "rose", source: "Student → Sponsor Tab", fields: [
    ...
    { key: "sponsor_dob", label: "জন্ম তারিখ" }, { key: "sponsor_dob:year", label: "জন্ম → Year" }, { key: "sponsor_dob:month", label: "জন্ম → Month" }, { key: "sponsor_dob:day", label: "জন্ম → Day" },
    { key: "sponsor_nid", label: "NID" },
    { key: "sponsor_father_name", label: "স্পন্সরের পিতা" }, { key: "sponsor_mother_name", label: "স্পন্সরের মাতা" },
    { key: "sponsor_present_address", label: "বর্তমান ঠিকানা" }, { key: "sponsor_permanent_address", label: "স্থায়ী ঠিকানা" }, { key: "sponsor_address", label: "ঠিকানা" },
    ...
    { key: "sponsor_trade_license", label: "ট্রেড লাইসেন্স" }, { key: "sponsor_tin", label: "TIN" },
  ...
  { group: "গন্তব্য", color: "cyan", source: "Student → Profile → Destination Info", fields: [
    { key: "country", label: "দেশ" }, { key: "school", label: "School" }, { key: "batch", label: "Batch" },
    { key: "intake", label: "Intake" }, { key: "visa_type", label: "ভিসার ধরন" }, { key: "student_type", label: "টাইপ" },
  ...
  { group: "সিস্টেম ভ্যারিয়েবল", color: "muted", source: "Auto: Settings / Batch / School থেকে", fields: [
    ...
    { key: "sys_today", label: "আজকের তারিখ" }, { key: "sys_today:year", label: "আজ → Year" }, { key: "sys_today:month", label: "আজ → Month" }, { key: "sys_today:day", label: "আজ → Day" },
    { key: "sys_today_jp", label: "আজকের তারিখ (日本語)" },
    { key: "sys_batch_name", label: "ব্যাচ নাম" }, { key: "sys_batch_start", label: "ব্যাচ শুরু" },
    { key: "sys_batch_start:year", label: "শুরু → Year" }, { key: "sys_batch_start:month", label: "শুরু → Month" }, { key: "sys_batch_start:day", label: "শুরু → Day" },
    { key: "sys_batch_end", label: "ব্যাচ শেষ" }, { key: "sys_batch_end:year", label: "শেষ → Year" }, { key: "sys_batch_end:month", label: "শেষ → Month" }, { key: "sys_batch_end:day", label: "শেষ → Day" },

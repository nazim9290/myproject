...
export const THEMES = {
  dark: {
    ...
    bg: "#0b0e14",
    bgAlt: "#111520",
    sidebar: "linear-gradient(180deg, #111520, #0b0e14)",
    sidebarText: "rgba(255,255,255,0.45)",
    sidebarTextActive: "#ffffff",
    sidebarActiveBg: "rgba(6,182,212,0.12)",
    sidebarHoverBg: "rgba(255,255,255,0.06)",
    card: "linear-gradient(135deg, #141825, #111520)",
    cardSolid: "#141825",
    border: "rgba(255,255,255,0.08)",
    inputBg: "rgba(255,255,255,0.06)",
    inputBorder: "rgba(255,255,255,0.08)",
    inputFocusBorder: "rgba(6,182,212,0.4)",
    text: "#f1f5f9",
    textSecondary: "#a1b0c4",
    muted: "#7389a4",
